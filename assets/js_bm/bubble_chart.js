...
// Vierter Button: Bildschirmzeit
  ...
  var screentimeCenters = { // Center locations of the bubbles. 
    'weniger als 1h': { x: 250, y: height / 2 },
...
var sorgenCenters = { // Center locations of the bubbles.
  ...
  var sorgenTitleX = { // X locations of the year titles.
    ...
    'mache mir eher Sorgen': 370,
    'mache mir eher keine Sorgen': 670,
    'mache mir keine Sorgen um meine Daten': 950
    
  };    

  
  // Sechster Button: Sorgenbarometer
...
// -----------------------------------------------------------------*/    
  ...
  var fillColor = d3.scale.ordinal()
    .domain(['1','2','3', '4','5','6'])
    .range(['#F3FF33', '#D4FF33', '#A8FF33', '#83FF33','#064FF33','#42FF33']);
  ...
  function showDetail(d) {
    ...
    var content = '<span class="name">Alter: </span><span class="value">' +
                 ...
                 '<span class="name">Ich mache mir sorgen um meine Daten: </span><span class="value">' +
                  d.sorgen +
                  '</span><br/>' +
                '<span class="name">Ich informiere much über Socialmedia: </span><span class="value">' +
                  d.informiert +
                  '</span><br/>' +
